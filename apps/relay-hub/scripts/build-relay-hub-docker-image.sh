...
IMAGE_TAG="content-relay-hub:$COMMIT_SHA"

# Allow overriding the output tarball path, but keep a relay-hub-local default.
OUTPUT_TARBALL=${1:-"$REPO_ROOT/apps/relay-hub/content-relay-hub-docker-image-$COMMIT_SHA.tar"}
